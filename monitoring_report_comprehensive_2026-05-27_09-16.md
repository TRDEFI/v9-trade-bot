...
**Execution Time:** 2026-05-27 09:16:08 UTC  
**Agent Version:** v1.0  
**Monitoring Cycle:** 1  
...
The Binance Futures trading bot monitoring agent executed successfully at 09:16 UTC. The system fetched live dashboard data, performed kline autopsies on **24 closed trades**, and generated **1 self-evolution suggestion(s)**.

**Overall Status:** 🟡 CAUTION

**Key Metrics:**
- **Capital:** $1779.28 (Session P&L: $-220.72, -11.0% drawdown)
- **Performance:** 9W / 15L (37.5% win rate)
...
| Capital | $1779.28 | ⚠️ Drawdown |

**Anomalies Detected:** Large loss: BLUAIUSDT $-45.70, High stop loss count: 13
...
### Trade 15: SKYAIUSDT LONG (RSI_OVERSOLD) ❌ LOSS
- **PnL:** $-28.19 | **Entry:** 02:30 | **Exit:** 02:31 | **Duration:** 1 min
- **Exit Reason:** HARD_STOP_LOSS
- **Entry Analysis:**
  - Candle Type: red
  - Volume Ratio: 0.81x
...
- **Performance Metrics:**
  ...
  - Runner Captured: 0.00%
  - Slippage: $-3.19
- **Autopsy Summary:** Entry on red candle Stop hit on green candle. PnL: $-28.19

### Trade 16: MONUSDT LONG (RSI_OVERSOLD) ✅ WIN
- **PnL:** $18.37 | **Entry:** 02:45 | **Exit:** 02:55 | **Duration:** 10 min
- **Exit Reason:** TAKE_PROFIT_TIME_DECAY
- **Entry Analysis:**
  - Candle Type: doji
  - Volume Ratio: 0.10x
...
- **Performance Metrics:**
  - Max Favorable: 0.45%
  - Max Unfavorable: 0.08%
  - Runner Captured: 0.45%
  - Slippage: $0.00
- **Autopsy Summary:** Entry on doji candle. PnL: $18.37

### Trade 17: PLUMEUSDT LONG (RSI_OVERSOLD) ✅ WIN
- **PnL:** $16.60 | **Entry:** 03:00 | **Exit:** 03:10 | **Duration:** 10 min
- **Exit Reason:** TAKE_PROFIT_TIME_DECAY
- **Entry Analysis:**
  - Candle Type: doji
  - Volume Ratio: 0.66x
...
- **Performance Metrics:**
  - Max Favorable: 0.52%
  - Max Unfavorable: -0.15%
  - Runner Captured: 0.52%
  - Slippage: $0.00
- **Autopsy Summary:** Entry on doji candle Pattern: rejection_wick. PnL: $16.60

### Trade 18: SAGAUSDT LONG (RSI_OVERSOLD) ❌ LOSS
- **PnL:** $-24.67 | **Entry:** 04:00 | **Exit:** 04:05 | **Duration:** 5 min
- **Exit Reason:** HARD_STOP_LOSS
- **Entry Analysis:**
  - Candle Type: doji
  - Volume Ratio: 0.39x
...
- **Performance Metrics:**
  ...
  - Runner Captured: 0.00%
  - Slippage: $0.33
- **Autopsy Summary:** Entry on doji candle Stop hit on doji candle. PnL: $-24.67

### Trade 19: ETHUSDT SHORT (MOMENTUM_SHORT) ✅ WIN
- **PnL:** $14.75 | **Entry:** 04:00 | **Exit:** 04:19 | **Duration:** 19 min
- **Exit Reason:** TAKE_PROFIT_TIME_DECAY
- **Entry Analysis:**
  - Candle Type: red
  - Volume Ratio: 0.52x
...
- **Performance Metrics:**
  - Max Favorable: 0.07%
  - Max Unfavorable: -0.35%
  - Runner Captured: 0.07%
  - Slippage: $0.00
- **Autopsy Summary:** Entry on red candle. PnL: $14.75

### Trade 20: DOGEUSDT SHORT (EMA_CROSS_DN) ❌ LOSS
- **PnL:** $-23.87 | **Entry:** 04:45 | **Exit:** 04:50 | **Duration:** 5 min
- **Exit Reason:** HARD_STOP_LOSS
- **Entry Analysis:**
  - Candle Type: doji
  - Volume Ratio: 0.63x
...
- **Performance Metrics:**
  ...
  - Runner Captured: 0.00%
  - Slippage: $1.13
- **Autopsy Summary:** Entry on doji candle Stop hit on doji candle. PnL: $-23.87

### Trade 21: FETUSDT SHORT (TREND_SHORT) ✅ WIN
- **PnL:** $30.52 | **Entry:** 06:00 | **Exit:** 06:03 | **Duration:** 3 min
- **Exit Reason:** TAKE_PROFIT
- **Entry Analysis:**
  - Candle Type: red
  - Volume Ratio: 0.64x
...
- **Performance Metrics:**
  ...
  - Runner Captured: 0.16%
  - Slippage: $0.00
- **Autopsy Summary:** Entry on red candle. PnL: $30.52

### Trade 22: SIRENUSDT SHORT (EMA_CROSS_DN) ❌ LOSS
...
### Trade 23: OPGUSDT SHORT (TREND_SHORT) ❌ LOSS
- **PnL:** $-23.81 | **Entry:** 07:00 | **Exit:** 07:03 | **Duration:** 3 min
- **Exit Reason:** HARD_STOP_LOSS
- **Entry Analysis:**
  - Candle Type: doji
  - Volume Ratio: 0.58x
...
- **Performance Metrics:**
  ...
  - Runner Captured: 0.00%
  - Slippage: $1.19
- **Autopsy Summary:** Entry on doji candle Pattern: rejection_wick Stop hit on doji candle. PnL: $-23.81

### Trade 24: XRPUSDT LONG (VOL_BREAKUP) ❌ LOSS
- **PnL:** $-3.12 | **Entry:** 08:15 | **Exit:** 09:15 | **Duration:** 60 min
- **Exit Reason:** TIME_STOP_HARD
- **Entry Analysis:**
  - Candle Type: red
  - Volume Ratio: 0.62x
...
- **Performance Metrics:**
  ...
  - Runner Captured: 0.00%
  - Slippage: $0.00
- **Autopsy Summary:** Entry on red candle. PnL: $-3.12
...
- Large loss detected: SKYAIUSDT LONG ($-28.19) on HARD_STOP_LOSS
- Large loss detected: SAGAUSDT LONG ($-24.67) on HARD_STOP_LOSS
- Large loss detected: DOGEUSDT SHORT ($-23.87) on HARD_STOP_LOSS
- Large loss detected: SIRENUSDT SHORT ($-23.81) on HARD_STOP_LOSS
- Large loss detected: OPGUSDT SHORT ($-23.81) on HARD_STOP_LOSS
...
- Rejection wick pattern led to 3 loss(es) - consider filtering
- Low volume entries (<0.5x) associated with 6 loss(es)
...
- **Current Capital:** $1779.28
- **Session P&L:** $-220.72 (-11.0% drawdown)
- **Forecast (24h):** $1419.52
- **Trend:** Negative momentum

**Recovery Analysis:** To recover the current drawdown of $220.72, the bot needs approximately 22 winning trades (based on average win of $10.28).
